...
export class MinimalPerfectHashTable {
    ...
    constructor(data){
        this.hash = MinimalPerfectHashTable.FNVHash;
        this.setData(data);
    }
...
MinimalPerfectHashTable.FNVHash = function(d = FNV_OFFSET_BASIS, str){
    ...
    return d >>> 0; //hard-clamps to 32 bit integer, loses sign (makes positive)
};